...
public class Rubbish_MonsterEntity extends AnimalEntity {
    public Rubbish_MonsterEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.RUBBISH_MONSTER.create(world);
    }
}
